...
from exception.resultado_vazio_exception import ResultadoVazioException
        ...
        try:
            ...
            if tem_qsa:
                ...
                html2 = await page.evaluate(
                    "(element) => element.innerHTML", await page.query_selector(".conteudo")
                )
